...
export const tokens = {
  colors: {
    light: {
      ...
      brand: '#629460', brandLight: '#F2F6F2', brandMid: '#C8D9C7', brandDark: '#3F603E', logo: '#629460',
    ...
    dark: {
      ...
      brand: '#8FB68D', brandLight: '#1F2A1F', brandMid: '#3F603E', brandDark: '#C8D9C7', logo: '#F4EEEC',
