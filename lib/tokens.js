...
export const tokens = {
  colors: {
    light: {
      ...
      brand: '#2F4BA6', brandLight: '#EEF1FB', brandMid: '#BCC9EA', brandDark: '#243B83', logo: '#2F4BA6',
      success: '#629460', successLight: '#F2F6F2', successMid: '#C8D9C7', successDark: '#3F603E',
    ...
    dark: {
      ...
      brand: '#8AA0DE', brandLight: '#1A2342', brandMid: '#2E3F6B', brandDark: '#7E96D8', logo: '#F4EEEC',
      success: '#8FB68D', successLight: '#1F2A1F', successMid: '#3F603E', successDark: '#C8D9C7',
